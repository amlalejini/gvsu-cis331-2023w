...
In fact, this page is generated with R Markdown!
Source code for this page [here](https://github.com/amlalejini/gvsu-cis331-2023w/tree/main/lecture-material/week-03).

## Dependencies

To use R markdown, you'll need to install the following packages: `markdown` and `rmarkdown`.
You should also want to go ahead and install the `tinytex` package (+ install TinyTex) to be able generate PDF output from your R Markdown documents.
...
For this class, you'll also need to be able to generate PDF output from your R Markdown documents.
To do so, you'll need to install LaTex (if you're not sure what that is, no worries!).
Run the following two commands in your R console in RStudio:
...
2. Fill out the title, author (you!), and date fields and press "Okay".
   This will create a new R markdown file, but RStudio will initialize your file with a bunch of stuff (this stuff is helpful information, but you will want to delete it all for any assignments in this class).
...
![](https://raw.githubusercontent.com/amlalejini/gvsu-cis331-2023w/main/lecture-material/week-03/media/minimal-rmd-example.png)
