...
However, if you would still prefer to work alone for the semester, that is fine.

Do not worry if you don't know anyone else in the class, I will take care of group assignment.
...
9. What grade do you expect to earn in this course?
...
13. Are you able to bring a computer to class to work on in-class activities using data analysis software?

## Part D. Data

For this part of your homework, identify a source of "big data" that you find interesting.

14. What source of big data did you choose and why?
15. Imagine you have a dataset from the source you identified.
